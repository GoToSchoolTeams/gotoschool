...
tf.eyeInfo[8] = %["fg"=>"s_naruse_pose2.png", "bg"=>"eyelevel_naruse_pose2.png"];
tf.eyeInfo[9] = %["fg"=>"s_satori_pose1_futsu.png", "bg"=>"eyelevel_satori.png"];
tf.eyeInfo[10] = %["fg"=>"s_orutega_pose2_kanasii.png", "bg"=>"eyelevel_orutega.png"];
tf.f_t_current = 0;
tf.f_t_top = 0;
tf.f_t_left = 0;
tf.f_t_size = 0;
