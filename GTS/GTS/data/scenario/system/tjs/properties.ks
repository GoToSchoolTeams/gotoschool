...
tf.StandTopMap["satori_old"] = new Dictionary();
tf.StandTopMap["satori_old"]["1"] = new Dictionary();
tf.StandTopMap["satori_old"]["1"]["s"] = 0;
tf.StandTopMap["satori_old"]["1"]["m"] = 0;
tf.StandTopMap["satori_old"]["1"]["l"] = 0;
