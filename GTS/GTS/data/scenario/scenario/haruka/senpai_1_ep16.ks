...
[fadeoutse time="1000"]
担当教員の退屈な説明を聞き流しながら、[lr]
器用に鳴き方を変える蝉の声に耳を傾けていた。[plc]
...
[fadeinbgm time="800" storage="chill"]
[shownametag name="大樹" visible=true]
「……じゃんけん？」[plc]



ウィンナーを口先に咥えたまま、俺は返事をする。[plc]
...
最近気づいたのだが、あれはどうもほうじ茶らしかった。[plc]


[shownametag name="大樹" visible=true]
「なんか決めるときは、クジとかかと思いました」[plc]


[shownametag name="遥香" visible=true]
「二人しかいないのにクジってのも面倒でしょ」[plc]
...
[shownametag name="大樹" visible=true bust="false"]
「……」[plc]
...
俺のチンケな脳みそで考えても、問題が山ほどみつかるんだけど。[plc]
...
いつの間にか、弁当はカラになっていた。[plc]


[shownametag name="大樹" visible=true]
「先輩、弁当うまかったっす。お世話になりました」[plc]
...
片っぽは……たしか、まんま『文化祭』だったな。[lr]
もう一つは、なんか『スポーツ大会』って感じで。[plc]
...
[shownametag name="教師" visible=true bust="false"]
「わかりました。では、負けた方は文化イベントの方で」[plc]



先生が、書類に必要事項を記入していく。[plc]
...
[JumpChapter storage="senpai_1_ep17.ks"]
