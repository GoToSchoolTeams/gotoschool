...
「髪型に規定は無いわ……それに、アレは地毛らしいし」[plc]


[shownametag name="大樹" visible=true]
「んなわけあるかよ、思いっきりヘアカラー色じゃん！」[plc]


[shownametag name="縁" visible=true]
「知らないわよ。そういうことになってんだから、[r]
そういうことなのよ」[plc]
...
あんなのが認められるなら、[r]
俺がちょっと演説でラリったくらいで怒んなよな先生たち……。[plc]

[shownametag name="縁" visible=true]
「……向かいの校舎まで、声が聞こえるわけないでしょうに」[plc]
...
[shownametag name="成瀬" visible=true]
「……あら、お気になさらず続けてもらっていいのよ？」[plc]


[shownametag name="成瀬" visible=true]
「確か、可哀想なお仲間を[r]
追い出す算段をしてらしたんじゃなくて？」[plc]
...
[shownametag name="成瀬" visible=true]
「今日は休みにしましたわ。なんというか、[lr]
今日はちょっと、蝉のさえずりが大きすぎるものですから」[plc]
...
[shownametag name="成瀬" visible=true]
「どうしたんですか旗立さん、そんなにかしこまって」[plc]


[shownametag name="成瀬" visible=true]
「さっきまであんなに『野蛮に』さえずってらしたのに」[plc]
...
[shownametag name="遥香" visible=true]
「えーっと、じゃぁとりあえず議題は……まぁ、これしかないか」[plc]

[shownametag name="遥香" visible=true]
「『谷口 大樹 を書記として罷免するか否か。及び谷口 大樹を構成員として除外するか否か』って感じでよろしく」[plc]
...
自分自身のあまりの酷さに、[lr]
俺自身、絶句してしまっていたから。[plc]

[fadeoutbgm time="1000"]
[strans storage="white" time="1000"]
[JumpChapter storage="senpai_0_ep5.ks"]
