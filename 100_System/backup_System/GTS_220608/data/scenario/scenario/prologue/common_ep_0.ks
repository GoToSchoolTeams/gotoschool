...
[shownametag name="大樹" visible=true]「おはよ」[plc]
...
[shownametag name="大樹" visible=true]「……は、」[plc]
...
[shownametag name="縁" visible=true]「……また？」[plc]
...
[shownametag name="縁" visible=true]「ちょっと」[plc]


襟首を掴まれた。[plc]


[shownametag name="大樹" visible=true]「何？」[plc]

[showstandimage who=najimi pose=1 face=ikari]
[shownametag name="縁" visible=true]「何？　じゃないでしょ、あんたもう一ヶ月になるのよ」[plc]


[showstandimage who=najimi pose=1 face=do]
[shownametag name="縁" visible=true]「それが――」[plc]


[shownametag name="大樹" visible=true]「それが？」[plc]
...
[shownametag name="縁" visible=true]「……そうね。私には『もう』関係なかった」[plc]


[shownametag name="大樹" visible=true]「……」[plc]

[showstandimage who=najimi pose=1 face=do]
[shownametag name="縁" visible=true]「……あんたがどうなろうが、『もう』知ったこっちゃない」[plc]
...
[showstandimage who=najimi pose=1 face=ikari]
[shownametag name="縁" visible=true]「……そう、関係ない」[plc]
[dis_all_chara_fade]

呟くように、囁くように、彼女は目を閉じる。[lr]
それは、自分にも言い聞かせているかのようで。[plc]

……だけれども、それこそ俺には関係ない。[plc]


本音で話さない奴に、何故本音をぶつけてやらなきゃならないんだ。[plc]


[shownametag name="大樹" visible=true]「……じゃ」[plc]


一声つぶやいて、彼女の横を通り抜けようとすると、[plc]
...
[shownametag name="大樹" visible=true]「なんだ――」[plc]

[showstandimage who=najimi pose=1 face=futsu]
[shownametag name="縁" visible=true]「――あんたの親御さんがどう思うか気になった」[plc]


一声。[plc]


[shownametag name="縁" visible=true]「……それだけよ」[plc]

[dis_all_chara_fade]
叩きつけるように楔を打ち込んで、彼女は去っていく。[plc]


[shownametag name="大樹" visible=true]「……っ」[plc]


舌打ちしてみるが、振り返りもしない。[plc]
