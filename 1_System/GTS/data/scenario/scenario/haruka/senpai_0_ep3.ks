...
うちの先生方は思った以上に優しかったらしい。[plc]



先輩陣営全員でひたすら謝り倒すことで、[lr]
...
[shownametag name="縁" visible=true]
「なわけないでしょ、
[showstandimage who=najimi_old face=futsu pose=1]
新聞部からくすね……
...
[strans storage="seitokai"]
[showstandimage who=najimi_old face=jitome pose=1]
[shownametag name="縁" visible=true]
「……」[plc]
...
[showstandimage who=najimi_old pose=1 face=ikari notrans="true" page=back] 
[strans storage="seitokai" noclear="true"]
[shownametag name="大樹" visible=true]
「あっはっはっはっは！」[plc]
...
[showstandimage who=najimi_old face=ikari pose=1 time="100" size=l]
[shownametag name="縁" visible=true]
「――コイツを！」[lr]
;[メッセージを更新してくような感じで]
...
[shownametag name="縁" visible=true]
「ここに入れた事や！　書記に選んだ事はもう言いません！！」[plc]



突き刺さんばかりに俺の顔面に指を突き出して、縁は叫ぶ。[lr]
その顔には、苦渋の決断がありありと読み取れた。[plc]


……よっぽど、文句が言いたかったらしいな。[plc]

[showstandimage who=najimi_old face=do pose=1 time="100" size=l]
[shownametag name="縁" visible=true]
...
[showstandimage who=najimi_old face=do pos=l notrans="true" page=back]
[showstandimage who=haruka_old face=magao pos=r notrans="true" page=back layer="2"]
[strans storage="seitokai" noclear="true"]
[shownametag name="縁" visible=true]
「ふざけないでくださいよ！
...
[showstandimage who=najimi_old pose=1 face=futsu pos=l]
いますぐコイツを放り出して…

[showstandimage who=najimi_old pose=1 face=do pos=l]
いや、いっそ切腹させましょう！」[plc]

[shownametag name="縁" visible=true]
「そうれば、女子票ならすぐ戻ってきますよ！！！」[plc]

[showstandimage who=najimi_old pose=1 face=ikari pos=l]
[shownametag name="縁" visible=true]
...
[showstandimage who=haruka_old pose=1 face=kuno pos=r layer="2"]
[shownametag name="遥香" visible=true]
「うーん」[plc]
...
[showstandimage who=haruka_old pose=1 face=ai pos=r layer="2"]
[shownametag name="遥香" visible=true]
「……いや、共学だよ。ココ？」[plc]
...
[showstandimage who=haruka_old face=magao pose=1]
[shownametag name="遥香" visible=true]
「あらま」[plc]
...
[showstandimage who=haruka_old face=jitome pose=1]
