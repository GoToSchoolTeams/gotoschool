...
[macro name="SetupMessageWindow"]
	...
	;平文レイヤは表示
	[position layer="message0" top=694 left=385 width=1212 height=200 opacity=0 visible="true"  page="fore" marginb="0" marginl="0" marginr="182" margint="0"]
	;ボタンレイヤはデフォ非表示
	[hide_ui]
	;顔レイヤも一旦非表示
	...
	[font size=30]
	;クリック待ちグリフ変更
	[glyph line="sakura" page="sakura" fix="true" top=80 left=1012]
	;裏にも適用
	[backlay]
	;BGMとSEのボリュームをもとに戻す
...
;;メッセージレイヤのボタンを表示するマクロ
[macro name=hide_ui]
	[position layer="message2" top="0" left="0" width="1600" height=900 opacity=0 visible="true" page="fore" marginb="0" marginl="0" marginr="0" margint="0" ]
	[current layer="message2"]
	[er]
	[locate x=687 y=844]
	[button graphic="toggle" onenter="kag.callExtraConductor('hidemessage.ks','*ShowButton')"]
	[current layer="message1"]
	[deffont size=38]
	[current layer="message0"]
	[deffont size=30]
...
[macro name=show_ui]
	...
	[er]
	[locate x=687 y=844]
	[button graphic="toggle" onleave="kag.callExtraConductor('hidemessage.ks','*HiddenButton')"]
	[locate x=1506 y=856]
